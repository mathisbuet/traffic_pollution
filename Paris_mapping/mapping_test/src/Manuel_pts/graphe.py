...
for x in points_array :
    ...
    if m == 0 or m == None: #si droite uniquement selon y ou uniquement selon x
        ...
        mAP = -1/m # coeff de la droite perpendiculaire à l'arete passant par A
        ...
        bY1 = p-offset
        bY2 =p+offset
        bY3 = yA-mAP*xA+(offset)
        bY4 = yA-mAP*xA-(offset)
        """
...
for line in edge_array :
    ...
    if left == 1:
        ...
        number_of_borders= writeBorder(f,printBorder(printPoint4(edge_array[line][0],1),printPoint4(edge_array[line][1],2), number_of_borders,False), number_of_borders)
        borders_coeff[number_of_borders] = 60
        number_of_borders=writeBorder(f,printBorder(printPoint4(edge_array[line][0],0),printPoint4(edge_array[line][1],3), number_of_borders,True), number_of_borders)
    elif right == 1:
        borders_coeff[number_of_borders] = 60
